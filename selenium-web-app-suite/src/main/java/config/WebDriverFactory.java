...
public class WebDriverFactory {
    ...
    public static WebDriver getWebDriver(DriverType driverType, Browser browser) throws Exception {
        ...
        driver.manage().timeouts().implicitlyWait(Duration.ofMillis(Integer.parseInt(Objects.requireNonNull(DataLoader.getAppData(FilePath.APP_DATA_FILE_PATH, "implicitTimeOut")))));
        return driver;
    }
