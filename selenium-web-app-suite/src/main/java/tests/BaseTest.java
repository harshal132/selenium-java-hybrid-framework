...
public class BaseTest {
    ...
    public void beforeSuite(@Optional("qa") String EnvType, @Optional("local") String testDriverType) {
        ...
        disableBrowserLocationTestCases = Arrays.asList(Objects.requireNonNull(DataLoader.getAppData(FilePath.APP_DATA_FILE_PATH, "disableBrowserLocationTestCases")).split(","));
    }
